 ...
 * Board identifier.
 */
#define BOARD_AT_START_F423
#define BOARD_NAME                  "Artery AT-START-F423"
 ...
 */
#define VAL_GPIOD_MODE              (PIN_MODE_INPUT(GPIOD_PIN0) |            \
...
#define VAL_GPIOD_OUTPUT            (PIN_OUTPUT_PUSHPULL(GPIOD_PIN0) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN1) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN2) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN3) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN4) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN5) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN6) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN7) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN8) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN9) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN10) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN11) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN12) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN13) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN14) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOD_PIN15))
...
#define VAL_GPIOD_PULL              (PIN_PULL_NONE(GPIOD_PIN0) |             \
                                     PIN_PULL_NONE(GPIOD_PIN1) |             \
                                     PIN_PULL_NONE(GPIOD_PIN2) |             \
                                     PIN_PULL_NONE(GPIOD_PIN3) |             \
                                     PIN_PULL_NONE(GPIOD_PIN4) |             \
                                     PIN_PULL_NONE(GPIOD_PIN5) |             \
                                     PIN_PULL_NONE(GPIOD_PIN6) |             \
                                     PIN_PULL_NONE(GPIOD_PIN7) |             \
                                     PIN_PULL_NONE(GPIOD_PIN8) |             \
                                     PIN_PULL_NONE(GPIOD_PIN9) |             \
                                     PIN_PULL_NONE(GPIOD_PIN10) |            \
                                     PIN_PULL_NONE(GPIOD_PIN11) |            \
                                     PIN_PULL_NONE(GPIOD_PIN12) |            \
                                     PIN_PULL_NONE(GPIOD_PIN13) |            \
                                     PIN_PULL_NONE(GPIOD_PIN14) |            \
                                     PIN_PULL_NONE(GPIOD_PIN15))
...
#define VAL_GPIOD_HDRV              (PIN_HDRV_NOTACTIVE(GPIOD_PIN0) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN1) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN2) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN3) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN4) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN5) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN6) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN7) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN8) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN9) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN10) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN11) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN12) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN13) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN14) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOD_PIN15))
 ...
 */
#define VAL_GPIOE_MODE              (PIN_MODE_INPUT(GPIOE_PIN0) |            \
...
#define VAL_GPIOE_OUTPUT            (PIN_OUTPUT_PUSHPULL(GPIOE_PIN0) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN1) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN2) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN3) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN4) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN5) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN6) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN7) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN8) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN9) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN10) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN11) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN12) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN13) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN14) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOE_PIN15))
...
#define VAL_GPIOE_PULL              (PIN_PULL_NONE(GPIOE_PIN0) |             \
                                     PIN_PULL_NONE(GPIOE_PIN1) |             \
                                     PIN_PULL_NONE(GPIOE_PIN2) |             \
                                     PIN_PULL_NONE(GPIOE_PIN3) |             \
                                     PIN_PULL_NONE(GPIOE_PIN4) |             \
                                     PIN_PULL_NONE(GPIOE_PIN5) |             \
                                     PIN_PULL_NONE(GPIOE_PIN6) |             \
                                     PIN_PULL_NONE(GPIOE_PIN7) |             \
                                     PIN_PULL_NONE(GPIOE_PIN8) |             \
                                     PIN_PULL_NONE(GPIOE_PIN9) |             \
                                     PIN_PULL_NONE(GPIOE_PIN10) |            \
                                     PIN_PULL_NONE(GPIOE_PIN11) |            \
                                     PIN_PULL_NONE(GPIOE_PIN12) |            \
                                     PIN_PULL_NONE(GPIOE_PIN13) |            \
                                     PIN_PULL_NONE(GPIOE_PIN14) |            \
                                     PIN_PULL_NONE(GPIOE_PIN15))
...
#define VAL_GPIOE_HDRV              (PIN_HDRV_NOTACTIVE(GPIOE_PIN0) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN1) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN2) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN3) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN4) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN5) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN6) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN7) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN8) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN9) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN10) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN11) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN12) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN13) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN14) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOE_PIN15))
...
#define VAL_GPIOF_OUTPUT            (PIN_OUTPUT_PUSHPULL(GPIOF_HEXT_IN) |    \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_HEXT_OUT) |   \
									                   PIN_OUTPUT_PUSHPULL(GPIOF_PIN2) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN6) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN8) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN9) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN10))
...
#define VAL_GPIOF_PULL              (PIN_PULL_NONE(GPIOF_HEXT_IN) |          \
                                     PIN_PULL_NONE(GPIOF_HEXT_OUT) |         \
									                   PIN_PULL_NONE(GPIOF_PIN2) |             \
                                     PIN_PULL_NONE(GPIOF_PIN6) |             \
                                     PIN_PULL_NONE(GPIOF_PIN8) |             \
                                     PIN_PULL_NONE(GPIOF_PIN9) |             \
                                     PIN_PULL_NONE(GPIOF_PIN10))
...
#define VAL_GPIOF_HDRV              (PIN_HDRV_NOTACTIVE(GPIOF_HEXT_IN) |     \
                                     PIN_HDRV_NOTACTIVE(GPIOF_HEXT_OUT) |    \
									                   PIN_HDRV_NOTACTIVE(GPIOF_PIN2) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN6) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN8) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN9) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN10))
